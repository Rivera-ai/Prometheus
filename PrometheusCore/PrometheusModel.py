...
class Prometheus(Module):
    ...
    def forward_modality(
        ...
        velocity_consistency_ema_model: Prometheus | None = None,
    ...
    def forward(
        ...
        velocity_consistency_ema_model: Prometheus | EMA | None = None,
        ...
        if isinstance(velocity_consistency_ema_model, EMA):
            assert isinstance(velocity_consistency_ema_model.ema_model, Prometheus)
